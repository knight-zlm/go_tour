...
// the tour package is introduced; the generated code references
// a constant, tour.SupportPackageIsVersionN (where N is generatedCodeVersion).
...
const (
	...
	grpcPkgPath    = "google.golang.org/tour"
	codePkgPath    = "google.golang.org/tour/codes"
	statusPkgPath  = "google.golang.org/tour/status"
)
...
// tour is an implementation of the Go protocol buffer compiler's
// plugin architecture.  It generates bindings for gRPC support.
type tour struct {
	gen *generator.Generator
}

// Name returns the name of this plugin, "tour".
...
func (g *tour) Generate(file *generator.FileDescriptor) {
	...
	g.P("// is compatible with the tour package it is being compiled against.")
...
//
// For semantics around ctx use and closing/ending streaming RPCs, please refer to https://godoc.org/google.golang.org/tour#ClientConn.NewStream.`, servName, servName))
